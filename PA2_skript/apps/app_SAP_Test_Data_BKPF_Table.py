...
class SAP_Test_Data_BKPF_Table(server.App): 
	if platform == 'darwin':
		link = "processed/SAP_Test_Data_BKPF Table.txt_processed"
	elif platform == 'win32':
		link = "processed\\SAP_Test_Data_BKPF Table.txt_processed"
...
#/******************************************/
	...
	def description_plot(self, params):
		...
		if platform == 'darwin':
			save(p,"picture/description_plot_SAP_Test_Data_BKPF_Table.html")
		elif platform == 'win32':
			save(p,"picture\\description_plot_SAP_Test_Data_BKPF_Table.html")
		return html
	...
	def unique(self, params):
		...
		html = "<center>"+html+"</center>"
		if platform == 'darwin':
			save(p,"picture/uniqueSAP_Test_Data_BKPF_Table.html")
		elif platform == 'win32':
			save(p,"picture\\uniqueSAP_Test_Data_BKPF_Table.html")
		return html
